...
<link href="/assets/application-73571cda686e7d86010f9b8bfc7011e6.css" media="all" rel="stylesheet" />
<link href="/assets/print-1df3ea9b8ff148a6745321899e0cb213.css" media="print" rel="stylesheet" />
<script src="/assets/application-5ad542bf6995c2d40719a914c59a0f44.js"></script>
<meta content="authenticity_token" name="csrf-param" />
<meta content="rSZWWDfI0e0N0NRKArDTAgLILFjogPmgVgmkA6xicUQ=" name="csrf-token" />
<script type="text/javascript">
//<![CDATA[
window.gon={};gon.default_issues_tracker="gitlab";gon.api_version="v3";gon.relative_url_root="";gon.default_avatar_url="http://114.215.173.43/assets/no_avatar-adffbfe10d45b20495cd2a9b88974150.png";
//]]>
</script>
...
<form accept-charset="UTF-8" action="/users/sign_in" class="new_user" id="new_user" method="post"><div style="display:none"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="rSZWWDfI0e0N0NRKArDTAgLILFjogPmgVgmkA6xicUQ=" /></div><input autofocus="autofocus" class="form-control top" id="user_login" name="user[login]" placeholder="Username or Email" type="text" />
